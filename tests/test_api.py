...
class TestPdfConverter(unittest.TestCase):
    ...
    # def test_convert_bulk_to_pdf(self):
    ...
    #     # Output path for the resulting ZIP file
    #     output_path = 'tests/output.zip'

    #     # Perform bulk conversion
    #     self.converter.convert_bulk_to_pdf(file_paths, output_path)

    #     # Assert that the output ZIP file exists
    #     self.assertTrue(os.path.exists(output_path))

    #     # Clean up: delete the output ZIP file
